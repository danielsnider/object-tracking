...
# sdram_freq=400
# over_voltage=0
# # from https://wiki.archlinux.org/index.php/Raspberry_Pi#Serial_console
...
#all 
sudo apt-get install build-essential cmake pkg-config unzip vim libjpeg8-dev libtiff4-dev libjasper-dev libpng12-dev libgtk2.0-dev libatlas-base-dev gfortran python-pip python2.7-dev
